...
class HUD: SKNode {
    ...
    func createHudNodes(screenSize: CGSize) {
        ...
        coinCountText.fontName = "AvenirNext-HevyItalic"
        let coinTextPosition = CGPoint(x: -cameraOrigin.x + 41, y: cameraOrigin.y)
